...
enum Config {
	...
	MAXVEHICLESLOADED = 150, // 70 on mobile
	...
	// Link list lengths
	NUMALPHALIST = 200,
	NUMBOATALPHALIST = 200,
	NUMALPHAENTITYLIST = 200,
	NUMALPHAUNTERWATERENTITYLIST = 300,
	NUMCOLCACHELINKS = 500,
	NUMREFERENCES = 8000,
	...
	NUM_PATH_NODES_IN_AUTOPILOT = 64,
	...
	NUMVISIBLEENTITIES = 16000,
	NUMINVISIBLEENTITIES = 1350,

	NUM_AUDIOENTITY_EVENTS = 4,
	NUM_PED_COMMENTS_SLOTS = 200,

	NUM_SOUND_QUEUES = 2,
	NUM_AUDIOENTITIES = 250,

	NUM_SCRIPT_MAX_ENTITIES = 400,
